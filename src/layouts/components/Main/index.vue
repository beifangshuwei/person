<template>
  <el-main>
    ...
    <div class="footer sm:w-100% md:w-450 lg:w-650 justify-center flex flex-col items-center pt-30 mb-30 fs-16 fw-600 color-#5970f8">    <hr class="mb-15 color-white"/>
      <hr class="mb-15 w-100% color-white"/>
      <div class="mb-10 ">
      ...
      <div>
        ...
        -
        <router-link to="/">Algorithm</router-link>
        -
