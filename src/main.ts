...
app.use(ElementPlus).use(vue3GoogleLogin, {
  clientId: '862419494654-sn2p35t0mvggscbkiidchs4ucjveidfe.apps.googleusercontent.com'
}).use(PublicCompnents).use(CyberUi).use(directives).use(router).use(I18n).use(pinia).mount('#app');
