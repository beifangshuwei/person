<template>
  <div class="person  flex flex-col items-center color-white">
    <div class="sm:w-100% md:w-450 lg:w-650  text-center">
      ...
      <el-button class="mt-20 w-100% h-30 lg:h-50 fs-20" type="primary" @click="downLoadFn">{{$t('person.downloadButton')}}</el-button>
...
const downLoadFn=async ()=>{
  router.push({path:"/download-page",params: { image: ImgUrl.value}})
}
