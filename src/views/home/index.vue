<template>
  ...
  <div class="person  sm:w-100% md:w-450 lg:w-650  text-center">
    ...
    <el-form :inline="true" :model="formInline" class="demo-form-inline">
      ...
      <el-form-item class="">
        <el-button type="primary" @click="onSubmit" v-loading="loading">Refresh Image</el-button>
      </el-form-item>
    </el-form>
    <img class="w-100%" :src="ImgUrl">
    <!--    <img class=" sm:w-100% md:w-450 lg:w-650"  src="@/assets/images/home/Or.webp">-->
    <el-button class="mt-20 w-100% h-30 lg:h-50 fs-20" type="primary" @click="downLoadFn">
...
const onSubmit = (item) => {
  // 当按钮为刷新状态时不可以刷新
  if (loading.value) return ElNotification({
    title: "提示",
    message: "正在加载中，请稍等",
    type: "warning",
    duration: 2000
